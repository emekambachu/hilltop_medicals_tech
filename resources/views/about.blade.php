...
@section('contents')
    ...
    <section class="about-4" id="about">
        ...
        <div class="container">
            <div class="content">
                <div class="video">
                    <div class="img">
                        <img src="{{ asset('main/about/a2.jpg') }}">
                    </div>
                </div>
                <div class="content-right">
                    <h4>Who We Are</h4>
                    <h1 class="section-title">Our <br><span>Technology</span> </h1>
                    <p>
                        Our industry-leading technology efficiently contributes to the healthcare industry. With our products we help improve the medical capability and sustainability. With a century of history and more than 450 innovative products and services, we are ready to meet today’s challenges in healthcare by creating solutions that deliver better care to more people at lower cost.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="our-numbers">
        <div class="our-numbers__bg"></div>
        <div class="container">
            <div class="">
                <div class="item">
                    <h1 class="text-white">The Team</h1>
                    <p class="text-white">Our executive team combines decades of industry expertise and a devotion to powering better healthcare through advanced technology. Our more than 37,000 employees, working in 100 countries, are committed to helping you create meaningful moments of care, whether in the hospital room, the living room or the boardroom. See how we are working to create a healthier future together.</p>
                </div>

            </div>
            <div class="our-numbers__img wow fadeInRight" data-wow-duration="1s">
                <img src="{{ asset('main/Healthcare/patient-monitor-500.jpg') }}">
            </div>
        </div>
    </section>
