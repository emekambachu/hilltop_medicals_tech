...
<head>
    ...
    <title>@yield('title') | Hilltop Medical Technology</title>
...
<div class="page">
                        ...
                        <div class="checkBox">
                            <ul class="products">
                                <li class="products-item">
                                    <div class="img">
                                        <img src="{{ asset('main/images/jpg/shop-arrivales3.jpg') }}">
                                    </div>
                                    <div class="text">
                                ...
                                <li class="products-item">
                                    <div class="img">
                                        <img src="{{ asset('main/images/jpg/shop-arrivales4.jpg') }}">
                                    </div>
                                    <div class="text">
                            ...
                            <a href="" class="btn btn_pink">Check out</a>
                        </div>
                    </div>
    ...
    <header class="header-bottom">
        ...
        <div class="header-bottom__banner owl-carousel owl-theme">
            ...
            <div class="slide-item">
                <img src="{{ asset('main/images/banner/banner1-1.jpg') }}">
            ...
            <div class="slide-item">
                <img src="{{ asset('main/images/banner/banner1-2.jpg') }}">
                <div class="slide-item__bg">
                    <div class="icon">
                        <img src="{{ asset('main/images/banner/banner-shape.png') }}">
                    </div>
            ...
            <div class="slide-item">
                <img src="{{ asset('main/images/banner/banner1-3.jpg') }}">
                <div class="slide-item__bg">
                    <div class="icon">
                        <img src="{{ asset('main/images/banner/banner-shape.png') }}">
                    </div>
            ...
            <div class="slide-item">
                <img src="{{ asset('main/images/banner/banner1-4.jpg') }}">
                <div class="slide-item__bg">
                    <div class="icon">
                        <img src="{{ asset('main/images/banner/banner-shape.png') }}">
                    </div>
        ...
        <div class="container">
            <div class="about__our-misson wow fadeInLeft" data-wow-duration="1s">
                ...
                <div class="about__our-misson-img">
                    <img src="{{ asset('main/images/jpg/about-img.jpg') }}">
                </div>
            ...
            <div class="about__text wow fadeInRight" data-wow-duration="1s">
                <h4>who we are</h4>
                <h1 class="section-title">Medical center<br><span>in new york</span> </h1>
                ...
                <div class="about__text-signature">
                    <img src="{{ asset('main/images/png/signature.png') }}" alt="signature">
    ...
    <section class="why-choose-us" id="why-us">
        <div class="why-choose-us__bg">
            ...
            <img src="{{ asset('main/images/png/nurse.png') }}" alt="">
        </div>
        <div class="container">
            ...
            <div class="difference">
                ...
                <div class="difference__item wow fadeInLeft" data-wow-duration="1s">
                    ...
                    <div class="difference__item-content">
                        ...
                        <p class="difference__item-text">We offer comprehensive health care focusing on the whole
                            person, at all ages and stages of life</p>
                    </div>
                </div>
                ...
                <div class="difference__item wow fadeInLeft" data-wow-duration="1s">
                    ...
                    <div class="difference__item-content">
                        <h1 class="difference__item-title">24 years experiens</h1>
                        <p class="difference__item-text">While our team brings important experience and knowledge,
                            we know that each patient is the expert in their own life</p>
                    </div>
                </div>
    ...
    <section class="appointments" id="departments">
        <div class="appointments__bg">
            <div class="icon">
                <img src="{{ asset('main/images/png-shapes/appointments-shape.png') }}">
            </div>
        </div>
        <div class="container">
            <div class="online-appointments">
                <h1 class="section-title">Online Appointments<br><span>and Prescriptions</span></h1>
            ...
            <a href="" class="btn btn_blue">REQUEST AN APPOINTMENT</a>
    ...
    <section class="other-services" id="services">
        <div class="other-services__bg">
            <img src="{{ asset('main/images/jpg/other-services.jpg') }}">
            <div class="icon">
                <img src="{{ asset('main/images/png-shapes/other-services-shape.png') }}">
            </div>
        </div>
    ...
    <section class="form">
        <div class="form__bg">
            <div class="circle-blue"></div>
            <div class="circle-pink"></div>
            <img src="{{ asset('main/images/png/doctor.png') }}">
            <div class="icon">
        ...
        <div class="container">
            <div class="form__block">
                <h1 class="section-title">Looking for<br><span>a Medical Technical Equipment?</span></h1>
                <p class="subtitle">We believe in providing the best possible care to all our existing clients.</p>
                <form action="" method="POST">
                    ...
                    <input class="form__block-input" type="text" placeholder="+1 123 465 78 99">
                    <input class="form__block-input" type="text" placeholder="Email*">
                    <textarea placeholder="Message"></textarea>
                    <button type="submit" class="btn btn_blue">SEND REQUEST</button>
    ...
    <section class="latest-news">
        <div class="latest-news__bg">
            <div class="icon">
                <img src="{{ asset('main/images/png-shapes/latest-news__right-bottom-shape.png') }}">
            </div>
        </div>
        <div class="container">
            ...
            <div class="latest-news__carousel owl-carousel owl-theme">
                ...
                <a href="" class="latest-news__item">
                    <div class="inner-block">
                        <div class="img">
                            <img src="{{ asset('main/images/jpg/latest-news1.jpg') }}">
                ...
                <a href="" class="latest-news__item">
                    <div class="inner-block">
                        <div class="img">
                            <img src="{{ asset('main/images/jpg/latest-news2.jpg') }}">
                            <h1 class="date">Now 28. 2019</h1>
                        </div>
                        <h4 class="title">Improvements in Technology</h4>
                        <p class="text">
                ...
                <a href="" class="latest-news__item">
                    <div class="inner-block">
                        <div class="img">
                            <img src="{{ asset('main/images/jpg/latest-news3.jpg') }}">
                            <h1 class="date">Now 28. 2019</h1>
                        </div>
                        <h4 class="title">Improvements in Technology</h4>
                        <p class="text">
                    ...
                    <div class="footer__top-blocks">
                        ...
                        <div class="content">
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#departments"><i class="fa fa-angle-right"></i>Products</a>
                                </li>
                                <li>
                                    <a href="#services"><i class="fa fa-angle-right"></i>Services</a>
                                </li>
                                <li>
                                    <a href="#why-us"><i class="fa fa-angle-right"></i>Contact us</a>
                                </li>
                            </ul>
                        </div>
                    </div>
